...
============================================ - Combined Script: ICONS
UPDATE + BATCH-10 Auto Upgrade + FILTERED Lucky Block Collector - +
selected-type Lucky Block Place + OPEN ALL active boxes + 10-slot Pickup
Range + Place-by-Mutation + CURRENT INDIVIDUAL earnings desc + Invis - +
expandable right-side Gift All inventory panel + HIGHEST CURRENT CASH/s
gift priority + Gift Count/Delay + Auto Accept Gifts + Pick Lowest
Profit by count - + WORKING Lucky Box collector preserved; invisibility
...
"Champions", "Spain", "Icons", "Alien", "Cheese", "MEME", "Japan", "US",
"Moon", "Planet", }
...
Block"] = true }, ["Icons"] = { ["Icons Lucky Block"] = true },
    ...
    ["Alien"] = { ["Alien Lucky Block"] = true },
    ["Cheese"] = { ["Cheese Lucky Block"] = true },
    ["MEME"] = { ["MEME Lucky Block"] = true },
    ["Japan"] = { ["Japan Lucky Block"] = true },
    ["US"] = { ["US Lucky Block"] = true },
    ["Moon"] = { ["Moon Lucky Block"] = true },
    ["Planet"] = { ["Planet Lucky Block"] = true },
