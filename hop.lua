...
-- if no Alternate Lucky Blocks are found.
...
local TARGET_NAME = "Alternate Lucky Block"
...
-- Find the highest-value Alternate Lucky Block
local function findBlock()
    ...
    local folder =
        live
        and live:FindFirstChild("Slimes")
            ...
            if isAlternate then
                ...
                if part then
                    ...
                    local v =
                        ...
                        or tonumber(m:GetAttribute("_MpsOverride"))
                        or 700000000
...
print(
    "[AlternateStealer] Auto-run ON | target = Alternate Lucky Block | hop to <=1 player servers if none after",
    EMPTY_SCANS_BEFORE_HOP,
    "empty scans"
)